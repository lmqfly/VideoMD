...
# 路径配置
raw_path = '/root/autodl-tmp/bio_emu_data/MSR_cath2'
tmp_path = '/root/autodl-tmp/tmp_msr_cath2'
out_path = '/root/autodl-tmp/video_msr_cath2'

# GPU配置
gpu_list = [0, 1]  # 三张GPU编号
...
def schedule_jobs():
    ...
    protein_dirs = [
        ...
        if os.path.isdir(os.path.join(raw_path, d)) and d.startswith('cath2_')
    ]
